<script lang="ts">
	...
	async function handleLogin(e: Event) {
		...
		try {
			...
			let targetRoute = "/admin"; // default
			
			if (role === "admin") {
				targetRoute = "/admin";
			} else if (role === "secretary") {
				targetRoute = "/secretary";
			} else if (role === "staff") {
				targetRoute = "/staff";
			} else {
				...
				if (dbRole === "secretary") targetRoute = "/secretary";
				else if (dbRole === "staff") targetRoute = "/staff";
			}
		...
		<div class="flex items-center gap-2">
			<DropdownMenu>
				...
				<DropdownMenuContent align="end">
					<DropdownMenuItem onSelect={() => i18n.setLocale("en")}>
						English
					</DropdownMenuItem>
					<DropdownMenuItem onSelect={() => i18n.setLocale("el")}>
						Ελληνικά
					</DropdownMenuItem>
				</DropdownMenuContent>
			</DropdownMenu>
